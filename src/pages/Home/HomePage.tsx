...
const CONTACT_INFO_CARDS = [
  {
    ...
    subtitle: hasPhone()
      ? SITE.serviceHours
      : "Email our team for trip assistance",
    detail: hasPhone() ? SITE.phoneDisplay || SITE.phoneTel : SITE.email,
    href: getPhoneHref() || `mailto:${SITE.email}`,
  },
  {
    title: "Email Support",
  ...
  {
    title: hasWhatsApp() ? "Chat on WhatsApp" : "Message Us",
    detail: hasWhatsApp()
      ? "Open WhatsApp for quick booking help"
      : "Use the contact form for written support",
    href: hasWhatsApp()
      ? getWhatsAppUrl("Hello Maseer, I would like booking help.")
      : "/contact",
  },
  {
                        ...
                        ("href" in card && card.href ? (
                          <a
                            ...
                            {...(card.href.startsWith("http")
                              ...
                              : {})}
                            className="mt-1 inline-block font-lato text-[13px] text-maseer-green hover:underline"
                          >
                            {card.detail}
                          </a>
                        ) : (
