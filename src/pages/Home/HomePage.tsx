...
import { SITE, getPhoneHref, hasPhone, hasWhatsApp, getWhatsAppUrl } from "src/config/site";
...
const CONTACT_INFO_CARDS = [
  {
    ...
    subtitle: hasPhone() ? SITE.serviceHours : "Email our team for trip assistance",
